...
public class App extends Application {
    ...
    public void showShowCreateEdit(Patientinformation patientinformation, String selectedDirection){
        try {
            FXMLLoader loader = new FXMLLoader();
            ...
            controller.setReference(this, patientinformation, selectedDirection); 
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
